...
namespace RBRProDashboard
{
    ...
    /// </summary>
    public partial class TyresDashboardGui : UserControl
    {
        IRbrPro _rbrPro = null;
        Model _model = null;
        TyresDashboardAddon _addon = null;

        public TyresDashboardGui(IRbrProAddOn addon, IRbrPro interactor, Model model)
        {
            _addon = (TyresDashboardAddon) addon;
        ...
        {
            TyresDashboard wrcDashboard = new TyresDashboard(_model, null);
            wrcDashboard.Show();
        }
    }
}
