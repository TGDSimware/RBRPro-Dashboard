...
namespace RBRProDashboard
{
    ...
    /// </summary>
    public class MSportDashboardAddon : IRbrProAddOn
    {
        ...
        public Image Icon => new Image { Source = new BitmapImage(new Uri($"pack://application:,,,/MSportDashboard;component/icon.png", UriKind.Absolute)) };
        ...
        {
            return new MSportDashboardGui(this, _interactor, _model);
        }
